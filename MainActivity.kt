...
fun Routes() {
    ...
    NavHost(
        ...
        //routine care of the normal newborn infant page route
        composable("RoutineCareoftheNormalNewbornInfant") {
            RoutineCareoftheNormalNewbornInfant().Content(navController)
        }
    }
}
